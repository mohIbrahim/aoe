...
@section('content')
	...
	<div class="container">
		...
		<div class="row">
	        		...
	        		<div class="thumbnail hvr-float" >	        			
		                ...
		                <div class="panel panel-default">
		                	<div class="panel-body" style="min-height: 300px">
		                		...
		                		<h5>
		                			<span style="color: red">Cloud Ready models</span>
		                		</h5>
	        ...
	        <div class="col-xs-10 col-xs-offset-1 col-sm-4 col-sm-offset-0 col-md-4 col-md-offset-0 col-lg-3 col-lg-offset-0">
	        		<div class="thumbnail hvr-float" >	        			
		                <a href="{{asset('images/products/4070N.jpg')}}" target="_blank" >
		                	<img src="{{asset('images/products/4070N.jpg')}}" class="img-responsive" alt="...">
		                </a>
		                <div class="panel panel-default">
		                	<div class="panel-body" style="min-height: 300px">
		                		<h4>
	        ...
	        <div class="col-xs-10 col-xs-offset-1 col-sm-4 col-sm-offset-0 col-md-4 col-md-offset-0 col-lg-3 col-lg-offset-0">
	        		<div class="thumbnail hvr-float" >	        			
		                <a href="{{asset('images/products/2314N.jpg')}}" target="_blank" >
		                	<img src="{{asset('images/products/2314N.jpg')}}" class="img-responsive" alt="...">
		                </a>
		                <div class="panel panel-default">
		                	<div class="panel-body" style="min-height: 300px">
		                		<h4>
